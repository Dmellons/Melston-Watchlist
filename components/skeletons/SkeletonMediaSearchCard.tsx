...
const SkeletonMediaSearchCard = () => {
  return (
    <Skeleton className="flex flex-col sm:flex-row justify-between items-center w-full sm:w-[400px] p-2 hover:z-0 hover:border hover:border-primary/50 h-[400px]">
